...
class test_planar_elbow_2dof_IDController(InverseDynamicsController):
    def __init__(self, robot):
        ...
        self.trajectoryGenerator.updateTrajectory(currentPosition=self.robot.getArm1Position(), goalPosition= self.goalPosition, currentTime= self.robot.getTime(), timeDuration=2.0)
    ...
    def updateState(self):
        self.position = self.robot.getArm1Position()()
        self.velocity = self.robot.getArm1Velocity()()
        self.theta1 = self.robot.getArm1Position()
        self.theta2 = self.robot.getArm1Position()
